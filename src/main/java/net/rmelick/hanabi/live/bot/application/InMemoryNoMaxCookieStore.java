 ...
 *
 */
class InMemoryNoMaxCookieStore implements CookieStore {
     ...
     * The default ctor
     */
    public InMemoryNoMaxCookieStore() {
            ...
            for (HttpCookie c : lst) {
                if ((c.getVersion() == 0 && netscapeDomainMatches(domain, host)) ||
                    ...
                    if ((cookieJar.indexOf(c) != -1)) {
                        ...
                        // RMELICK removed the expiration logic
                ...
                if (indexedCookies != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (cookieJar.indexOf(ck) != -1) {
                            // the cookie still in main cookie store
                            // RMELICK remove the expiration logic
                            // don't add twice
